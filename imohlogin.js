...
const confirmPasswordInput = document.querySelector('#passwordagaindaddy');
...
const requiredMessage = "**daddy it is needed.";
...
function checkpasswordagaindaddy(){
    let valid = false;
    const passwordagaindaddy = passwordagaindaddyInput.value.trim();
    const password = passwordInput.value.trim();

    if (!isRequired(passwordagaindaddy)) {
        showError(passwordagaindaddyInput, 'Please enter the password again');
    } else if (password !== passwordagaindaddy) {
        showError(passwordagaindaddyInput, 'The password does not match');
    } else {
        showSuccess(passwordagaindaddyInput);
        valid = true;
    }
